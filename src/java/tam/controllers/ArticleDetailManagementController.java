 ...
 * @author hoang
 */
public class ArticleDetailManagementController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("approveArticle")) {
                if (blogDAO.approveArticle(blogID)) {
                    url = SUCCESS;
                } else {
            ...
            log("ERROR at ArticleDetailManagementController: " + e.getMessage());
        } finally {
