...
public class AccountActivatingController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String inputedVerifyingCode = request.getParameter("inputedVerifyingCode");
            if (inputedVerifyingCode.equals(verifyingCode)) {
                AccountDAO accountDAO = new AccountDAO();
                if (accountDAO.activeAccount(activateEmail)) {
                    url = SUCCESS;
                } else {
            ...
            log("ERROR at AccountActivatingController: " + e.getMessage());
        } finally {
